...
\begin{itemize}
    \item MNIST~\cite{Deng2012TheMD}: dataset de dígitos escritos a mano. Actuara como dataset de debugging, contando con imágenes pequeñas y simples de clasificar,
