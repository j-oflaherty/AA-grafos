...
El código implementado puede consultarse en el repositorio de GitHub \url{https://github.com/j-oflaherty/AA-grafos/blob/main/lab4/Castro_OFlaherty_Lab5_AAG2025.ipynb}.
...
de la figura~\ref{fig:resultados_arxiv_gatv2}. La búsqueda de hiperparámetros se realizó tomando los mismos valores que para el modelo GAT.
